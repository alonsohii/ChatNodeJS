...
// cookies 
// https://stackoverflow.com/questions/31416874/check-returning-visitors-using-cookies

		var transport = '<table class="fcktable">\
						<tbody class=""> \
							<tr><td>Title 1B</td> \
								<td><a href="#"><i id="clickEmotic"  data-id="happy" alt=":)" class="emotic-happy moticsize"></i></a></td>\
								<td><a href="#"><i id="clickEmotic"  data-id="happy" alt=":D" class="emotic-superhappy moticsize"></i></a></td>\
								<td><a href="#"><i id="clickEmotic"  data-id="happy" alt=":(" class="emotic-sad moticsize"></i></a></td>\
								</tr>\
							<tr><td><a href="#"><i id="clickEmotic"  data-id="happy" alt="8)" class="emotic-nerd moticsize"></i></a></td>\
							<td><a href="#"><i id="clickEmotic"  data-id="happy" alt=":P" class="emotic-lengua moticsize"></i></a></td>\
							<td><a href="#"><i id="clickEmotic"  data-id="miedo" alt="D:" class="emotic-miedo moticsize"></i></a></td>\
							</tr>\
						</tbody>\
						</table>';
		var starwars = '<div>\
