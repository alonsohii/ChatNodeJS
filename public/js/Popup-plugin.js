...
function createToolTipChat(args){

	var parentContent = args.parent;
	var topToolTip = args.top;
	var bottomToolTip = args.bottom;
	var leftToolTip = args.left;
	...
	var Popup = {
		...
		init: function(options, elem) {
			...
			.appendTo(parentContent).css("opacity", 0).hide();
		...
		setPosition: function() {
			...
			var chatID = $($(this.$elem).parent().parent().parent().parent().parent()[0]).attr('id');

			var widthLeftContenedor = $('#'+chatID+'left').width();
			
			widthLeftContenedor = (widthLeftContenedor < 101? 0: widthLeftContenedor )+60;

			var x = self.coords.left;
			x = widthLeftContenedor;
